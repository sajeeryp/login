...
import 'package:itujar_login/ui_screens/start_bsns_discription.dart';
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(padding: EdgeInsets.only(
                    top: 10,bottom: 70,left: 0,right: 250,
                  ),
            ...
            Padding(padding: EdgeInsets.only(
              ...
              child: const Text('forgot password', style: const TextStyle(fontStyle: FontStyle.italic ),),
                  ...
                  Container(
                    ...
                    width: 345,
                    child: FlatButton(
                      child: Text("Cashier Login"   , style: TextStyle(color: Colors.white, fontSize: 15),),
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const start_dis()),
                        );},
                  ...
                  Padding(padding: EdgeInsets.only(
                    ...
                    child: TextButton(
                      ...
                      child: const Text('New User? Sing up', style: const TextStyle(fontStyle: FontStyle.normal ),),
                    ),),

                  Padding(padding: EdgeInsets.only(
                    top: 0,bottom: 10,left: 225,right: 0,
                  ),
                    child: Center(child: Image.asset("Assets/images/chat.png" , height: 50,width: 50,)),),
